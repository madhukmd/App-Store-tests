...
class AppStore extends Component {
  ...
  clickTabItem = tabIdValue => {
    this.setState({activeTabId: tabIdValue})
  }
  ...
  render() {
    ...
    const filterTabApps = this.filterTabApps()

    const searchListItems = filterTabApps.filter(eachItem =>
